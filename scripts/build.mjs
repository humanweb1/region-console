...
const entries = [
  ...
  "./src/features/auth/rbac-scope-ui.js",
  "./src/features/auth/rbac-management.js",
  "./src/features/auth/rbac-role-save-fix.js",
  "./src/features/auth/rbac-permission-click-fix.js",
  "./src/features/campaigns/campaign-ui.js",
  "./src/features/files/files.js",
  "./src/features/files/files-display-modes.js",
  ...
  "./src/features/drawing/province-select-completeness-fix.js",
...
async function main() {
  ...
  const temp = await mkdtemp(join(tmpdir(), "region-console-build-"));
  ...
  await writeFile(join(dist, "assets", "app.css"), css, "utf8");
